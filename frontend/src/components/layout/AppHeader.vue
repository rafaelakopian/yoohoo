...
import { LogOut, UserRound, ChevronDown, Settings, Palette, Menu } from 'lucide-vue-next'
...
<template>
  <div class="flex items-center justify-between md:justify-end gap-2 mb-4 md:mb-0 md:absolute md:top-3 md:right-6 z-50">
    <!-- Hamburger menu — alleen mobiel -->
    <button
      @click="emit('toggle-sidebar')"
      class="p-2 rounded-lg hover:bg-surface transition-colors md:hidden"
    >
