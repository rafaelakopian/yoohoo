...
from app.modules.products.school.schedule.models import Holiday, LessonInstance, LessonSlot, LessonStatus
from app.modules.products.school.schedule.schemas import (
    CalendarDayEntry,
