...
async def test_link_and_list_parent_children(
    ...
    link_resp = await tenant_client.post(
        f"/api/v1/org/test/students/{student1_id}/parents",
    ...
    list_resp = await tenant_client.get(
        "/api/v1/org/test/students/my-children",
...
async def test_teacher_sees_assigned_students(
    ...
    await tenant_client.post(
        f"/api/v1/org/test/students/self-assign/{student1_id}",
        headers=ctx["teacher_headers"],
    )
    await tenant_client.post(
        f"/api/v1/org/test/students/self-assign/{student2_id}",
        headers=ctx["teacher_headers"],
    )
...
async def test_unlink_parent(
    ...
    # Link
    await tenant_client.post(
        f"/api/v1/org/test/students/{student_id}/parents",
    ...
    del_resp = await tenant_client.delete(
        f"/api/v1/org/test/students/{student_id}/parents/{ctx['parent_id']}",
        headers=tenant_auth_headers,
    )
